...
public class ArrayListCollectionME
{
   public static void main( String[] args )
   {
      // create a new ArrayList of Strings with an initial capacity of 10
      ArrayList< String > items = new ArrayList< String >(); // <String> store only strings
      // wrapper classes are classes that correspond to primitive types, eg. int == <Int>
